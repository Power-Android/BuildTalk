...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CountCheckRecord = new Property(10, int.class, "countCheckRecord", false, "COUNT_CHECK_RECORD");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"COUNT_CHECK_RECORD\" INTEGER NOT NULL );"); // 10: countCheckRecord
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(11, entity.getCountCheckRecord());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getInt(offset + 10) // countCheckRecord
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setCountCheckRecord(cursor.getInt(offset + 10));
     }
