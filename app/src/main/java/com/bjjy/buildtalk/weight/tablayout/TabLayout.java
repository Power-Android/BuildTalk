...
package com.bjjy.buildtalk.weight.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    private boolean tabDividerWidthWidthText = false;
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabDividerWidthWidthText = a.getBoolean(R.styleable.TabLayout_tabDividerWidthWidthText, false);
    ...
    class TabView extends LinearLayout {
        ...
        public int getTextWidth() {
            ...
            //自定义带图标view时 设置宽度为文字+图标的宽度
            if (mCustomView != null && mCustomView.getWidth() > 0){
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                ...
                RectF rectF = new RectF(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
                    ...
                    canvas.drawRoundRect(rectF, 30, 30, mSelectedIndicatorPaint);
            }
        }
    }
