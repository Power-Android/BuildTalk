 ...
 * @description:
 */
public class CircleSearchResultAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    public CircleSearchResultAdapter(int layoutResId, @Nullable List<String> data) {
